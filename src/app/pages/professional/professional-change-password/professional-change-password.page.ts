...
@Component({
  ...
  templateUrl: './professional-change-password.page.html',
  styleUrls: ['./professional-change-password.page.scss'],
  standalone: true,
  imports: [IonContent, CommonModule, FormsModule, ReactiveFormsModule]
})
export class ProfessionalChangePasswordPage implements OnInit {
  ...
  updatePassword() {
    ...
    this.professionalService.updateProfessionalPassword({ email : user.email ,oldPassword : oldPassword, newPassword : newPassword }).subscribe(async(res:any)=> {
        if (res.message === 'success') {
          ...
          this.navCtrl.navigateBack('/professional-edit-profile');
          return;
        } 
